...
import static browser.SetupBrowser.browserDriverSetUp;

public class BaseActions {
    public static final String MAIN_PAGE = "https://stellarburgers.nomoreparties.site/";
    private final String email = "GvozdkovAlex1993@yandex.ru";
    private final String password = "123456";
    private final String name = "AleksandrGvozdkov_19";
